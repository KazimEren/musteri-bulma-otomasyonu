...
- brandName: Açıklamada net bir şekilde geçen bir marka/ürün/şirket adı (özel isim) varsa onu AYNEN yaz (ör. "BörüCASE"). Açıklama sadece genel bir hizmet tanımıysa ve belirgin bir özel isim geçmiyorsa boş string ("") döndür — TAHMİN ETME, uydurma bir marka adı üretme.

Sadece şu anahtarları içeren HAM bir JSON objesi döndür: sectors (string[]), keywords (string[]), locations (string[]), brandName (string). Markdown, açıklama, ek metin YOK.`;
}
